            ...
            >
              <Container fixed className={classes.formContainerBlue}>
                ...
                <TextField
                  ...
                  onChange={(event: any) =>
                    handleChangeLoginLogin(event.target.value)
                  }
                ...
                <TextField
                  ...
                  className={classes.textFieldStyle}
                  onChange={(event: any) =>
                    handleChangePasswordLogin(event.target.value)
                  }
                  onKeyDown={onEnterDown}
                />
                <Button
            ...
            >
              <Container fixed className={classes.formContainerRed}>
                ...
                <TextField
                  ...
                  className={classes.textFieldStyle}
                  onChange={(event: any) =>
                    handleChangeLoginRegister(event.target.value)
                  }
                  onKeyDown={onEnterDown}
                />
                <TextField
