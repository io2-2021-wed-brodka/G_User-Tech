                ...
                <li key={bike.id}>
                  ...
                  >
                    ...
                    <ThemeProvider theme={themeWarning}>
                      <Button
                        className={classes.returnBikeButton}
                        id={`return-bike-button-${index}`}
                        startIcon={<DirectionsBikeIcon />}
                        onClick={handleOpenReturnBike}
                      >
                        {" "}
                        RETURN
                      </Button>
                      ...
                      >
                        ...
                        <DialogActions>
                          <Button
                            id="dialog-return-bike-button-confirm"
